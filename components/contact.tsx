...
export default function Contact() {
  ...
  const handleDownloadResume = async () => {
    try {
      ...
      a.href = url
      a.download = "Arda_Gundogdu_Resume.txt"
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            I'm actively seeking international AI/ML internship opportunities. Open to conversations about
            Gen AI projects, research collaborations, or positions where I can contribute to cutting-edge AI systems.
          </p>
        </motion.div>
