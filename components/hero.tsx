      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <TextGenerateEffect
              words="Building intelligent systems with LLMs, RAG pipelines, and Knowledge Graphs. Passionate about creating AI agents that bridge natural language and complex workflows."
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            {[
              { value: "LLMs", label: "Fine-tuning & Inference" },
              { value: "RAG", label: "Graph RAG & Vector Search" },
              { value: "MCP", label: "Autonomous Agent Systems" },
            ].map((stat, idx) => (
              <motion.div
                key={idx}
                variants={itemVariants}
